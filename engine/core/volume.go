...
//	}
//	dirs := "dirs=" + parentUrl
//	_, err := exec.Command("merge", "-t", "aufs", "-o", dirs, "none", containerVolumeURL).CombinedOutput()
//	if err != nil {
...
//	_, err := exec.Command("merge", "-t", "aufs", "-o", dirs, "none", mntURL).CombinedOutput()
//	if err != nil {
//		log.Errorf("Run command for creating merge point failed %v", err)
//		return err
//	}
//	return nil
//}
